          ...
          <div className="mx-auto  px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16  items-center justify-between">
              ...
              <div className="flex w-full gap-10 items-center justify-center  sm:flex sm:justify-between">
                ...
                <div id="nav-content" className="hidden flex pl-10 flex-grow items-center justify-between  me-10 gap-10 sm:flex ">
                  <div id="first nav" className="hidden pl-10 md:flex space-x-4 ">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                  ...
                  <div id="second nav" className=" flex space-x-4">
